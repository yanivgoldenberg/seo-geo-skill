...
**Stack:** WordPress + a page builder + Rank Math + Cloudflare
**Session:** April 2026
...
2. **Plugin-as-SEO-filter** pattern - a single must-use plugin hardcodes homepage title, meta, OG image, schema logo, favicon, theme-color, and AI-crawler robots rules (Phase 16, Pattern 3)
...
4. **Media library 4-field metadata** applied to every media item via REST batch (Phase 16, Pattern 2)
...
- Page-builder header/footer HTML beyond scoped insertion
